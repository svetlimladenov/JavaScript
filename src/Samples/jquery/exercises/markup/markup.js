...
const parse = function parse(selector, $) {
    const createRegularTag = function createNewString(
        index,
        string,
        symbol,
        closingTag,
    ...
    const createAnchorTag = function createAnchorTag(
        index,
        string,
        symbol,
        closingTag,
        ...
        const replaceTag = isOpening
            ? `<${replaceString} href='${linkUrl}'> ${linkText}`
            : `</${replaceString}>`;
    ...
    function replace(
        ...
        if (index > -1) {
            const editedLine = newStringAction(
                index,
                line,
                openingSymbol,
                closingSymbol,
    ...
    const replaceTags = {
        bold: {
            ...
            openingString: "'''",
            closingString: "'''",
            newStringAction: createRegularTag,
        },
        italic: {
            tag: "i",
            openingString: "''",
        ...
        anchor: {
            ...
            openingString: "[[",
            closingString: "]]",
            newStringAction: createAnchorTag,
        },
    };
